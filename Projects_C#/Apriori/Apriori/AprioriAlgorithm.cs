...
namespace Apriori
{
    class AprioriAlgorithm
    {
        ...
        public static Dictionary<int, List<int>> recordMap = new Dictionary<int, List<int>>();
        ...
        public static Dictionary<int, List<int>> videoRankTwo = new Dictionary<int, List<int>>();    //二层排名
        public static Dictionary<int, int> frequTimeOne = new Dictionary<int, int>();           //一层的频率
        public static Dictionary<List<int>, int> frequTimeTwo = new Dictionary<List<int>, int>(new ListCompare());     //二层的频率
        ...
        {       //寻找二层频繁集合
            ...
            for (int i = 0; i < freOne.Count; i++)
            {
                for (int j = i + 1; j < freOne.Count; j++)
                {
                    ...
                    if (ratioTwo >= minSupThreshold)
                    {
                        ...
                        Console.Write("(" + temp[0] + "," + temp[1] + ") "+togetherNum+", ");
                    }
                }
            }
            Console.WriteLine();
            ...
            {                                                    //根据支持度排序videoRankTwo
                ...
                {            //lamda表达式
                    ...
                    {
                        num1 = frequTimeTwo[l11];
                    }
                    else if (frequTimeTwo.ContainsKey(l12))
                    {
                        num1 = frequTimeTwo[l12];
                    }
                    List<int> l21 = new List<int>();
                    List<int> l22 = new List<int>();
                    l21.Add(entry.Key);
                    l21.Add(o2);
                    l22.Add(o2);
                    l22.Add(entry.Key);
                    ...
                    {
                        num2 = frequTimeTwo[l21];
                    }
                    else if (frequTimeTwo.ContainsKey(l22))
                    {
                        num2 = frequTimeTwo[l22];
                    }
                    return num2 - num1;
                });
            }
